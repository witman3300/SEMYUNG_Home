...
(function () {
  ...
  const T = {
    ...
    // 자주 묻는 질문 (구조화 데이터 FAQPage와 동일 문안 유지)
    'faq.label': ['FAQ', 'FAQ'],
    'faq.title': ['자주 묻는 질문', 'Frequently Asked Questions'],
    'faq.desc': ['입주 전 가장 많이 확인하시는 내용을 모았습니다', 'The questions we hear most before move-in'],
    'faq.q1': ['비상주사무실 이용료는 얼마인가요?', 'How much does a virtual office cost?'],
    'faq.a1': ['<p>개인사업자는 월 5만원, 법인은 월 7.5만원입니다. 6개월 일시불 결제 시 50% 할인된 금액 기준이며, 모든 금액은 부가세 별도입니다.</p>',
      '<p>KRW 50,000/month for sole proprietors and KRW 75,000/month for corporations. Rates assume a 50% discount for six months paid upfront; VAT is excluded.</p>'],
    'faq.q2': ['비상주사무실로 사업자등록이 가능한가요?', 'Can I register a business at the virtual office?'],
    'faq.a2': ['<p>가능합니다. 서울특별시 중구 삼일대로 363 장교빌딩 810호 주소로 개인·법인 사업자등록을 하실 수 있습니다. 다만 단기 상주 사무실(하루·일주일·한 달)은 사업자등록이 불가합니다.</p>',
      '<p>Yes. You can register a sole proprietorship or a corporation at Janggyo Building #810, Samil-daero 363, Jung-gu, Seoul. Short-term offices (daily, weekly, monthly) cannot be used for business registration.</p>'],
    'faq.q3': ['상주 사무실 요금은 어떻게 되나요?', 'What are the resident office rates?'],
    'faq.a3': ['<p>월 기준으로 고정석 30만원, 1인실 40만원, 2인실 50만원, 3인실 60만원입니다. 상주 사무실은 보증금이 별도이며 월 단위 계약입니다.</p>',
      '<p>Per month: KRW 300,000 for a fixed desk, 400,000 for a 1-person room, 500,000 for a 2-person room and 600,000 for a 3-person room. A deposit applies and contracts run monthly.</p>'],
    'faq.q4': ['하루나 일주일만 단기로 이용할 수 있나요?', 'Can I rent for just a day or a week?'],
    'faq.a4': ['<p>가능합니다. 하루 1만 5천원, 일주일 9만원, 한 달 40만원으로 이용하실 수 있습니다. 단기 상주 사무실은 사업자등록 용도로는 사용할 수 없습니다.</p>',
      '<p>Yes — KRW 15,000 per day, 90,000 per week, or 400,000 per month. Short-term offices cannot be used for business registration.</p>'],
    'faq.q5': ['회의실은 별도 비용이 드나요?', 'Is the meeting room charged separately?'],
    'faq.a5': ['<p>상주·비상주 입주 대표님 모두 최대 3시간까지 무료로 이용하실 수 있습니다. 외부 클라이언트 미팅에 활용하시면 됩니다.</p>',
      '<p>No. Both resident and virtual-office tenants can use it free for up to three hours — ideal for meeting outside clients.</p>'],
    'faq.q6': ['가장 가까운 지하철역은 어디인가요?', 'Which subway station is closest?'],
    'faq.a6': ['<p>2·3호선 을지로3가역이 가장 가깝습니다. 을지로2가 1번 출구(그라츠 제과점)로 나오시면 장교빌딩 지하와 직접 연결되어 있어 8층까지 바로 올라오실 수 있습니다. 1호선 종각역, 4호선 명동역, 5호선 종로3가역도 도보권입니다.</p>',
      '<p>Euljiro 3-ga Station (lines 2 and 3). Take Euljiro 2-ga Exit 1 (Gratz Bakery) — it connects straight into the Janggyo Building basement, so you can go up to the 8th floor directly. Jonggak (line 1), Myeongdong (line 4) and Jongno 3-ga (line 5) are also within walking distance.</p>'],
    'faq.q7': ['주차가 가능한가요?', 'Is parking available?'],
    'faq.a7': ['<p>내비게이션에 “장교빌딩 주차장”을 검색해 오시면 됩니다. 반드시 지하 2층에 주차해 주세요. 지하 3층은 한화빌딩 주차장입니다.</p>',
      '<p>Search “Janggyo Building Parking” in your navigation app. Please park on B2 — B3 belongs to the Hanwha Building.</p>'],
    'faq.q8': ['지방에 있어도 계약할 수 있나요?', 'Can I sign a contract from outside Seoul?'],
    'faq.a8': ['<p>네, 지방에 계신 분도 방문 없이 온라인으로 계약이 가능합니다. 자세한 절차는 02-762-3009로 문의해 주세요.</p>',
      '<p>Yes — contracts can be signed online without visiting. Call +82-2-762-3009 for the details.</p>'],
    'faq.q9': ['우편물과 택배는 어떻게 받나요?', 'How is mail and parcel handled?'],
    'faq.a9': ['<p>애니워크(비상주) 서비스를 통해 우편물과 택배를 수신·발신해 드리며, 도착한 우편물은 스캔 또는 사진으로 전송해 드립니다.</p>',
      '<p>Our Anywork service receives and sends mail and parcels on your behalf, and forwards arriving mail as a scan or a photo.</p>'],
    'faq.q10': ['운영 시간은 어떻게 되나요?', 'What are the opening hours?'],
    'faq.a10': ['<p>24시간 연중무휴로 운영합니다. 입주 대표님은 언제든지 출입해 업무를 보실 수 있습니다.</p>',
      '<p>Open 24 hours a day, all year round. Tenants can come and go at any time.</p>'],
